...
references:
  ...
  - text: "Mekhontsev, D. (2026). The aspect ratio of the Twin Dragon is 1/φ. Preprint."
...
The boundary dimension is the same as that of the [Heighway Dragon](/ifs/heighway-dragon), since both
IFS share the same neighbour graph over the Gaussian integer lattice $\mathbb{Z}[i]$.
